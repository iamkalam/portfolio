      ...
      <div className="w-left">
        <div className="awesome">
          ...
          <spane>
            ...
            <a href="" target="_blank" className="linkeror">
              Upwork.com </a>
            <br /><br />
            {/* ispum is simpley dummy text of printingLorem ispum is simpley dummy */}
            <a href="https://www.fiverr.com/ersalna_pk" target="_blank" className="linkeror">
              Fiver.com </a>
            <br /><br />
            {/* y dummy text of printingLorem */}
            <a href="https://www.linkedin.com/in/arsalanahmadws/" target="_blank" className="linkeror">
              Linkdin.com </a>
            <br />
